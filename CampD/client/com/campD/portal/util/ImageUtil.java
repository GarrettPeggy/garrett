...
public class ImageUtil {
	...
	public void multiply(int timesToMultiplyVertically, int timesToMultiplyHorizantelly, int colorToHenhancePerPixel){
        ...
        BufferedImage result = new BufferedImage(width*timesToMultiplyVertically, height*timesToMultiplyHorizantelly, bufferedImage.TYPE_INT_BGR);
    ...
    public static void main(String[] args) {
        ...
        ImageUtil image  = new ImageUtil("d:/test/renwu.jpg");
        image.saveAs("d:/test/renwu_压缩到指定大小.jpg");
