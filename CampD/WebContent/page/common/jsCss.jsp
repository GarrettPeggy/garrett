...
<script type="text/javascript" src="${locResPath}/static/common/hammer/hammer.min.js?_v=${vs}"></script>
<script type="text/javascript" src="${locResPath}/static/common/jquery.hammer.js?_v=${vs}"></script>
