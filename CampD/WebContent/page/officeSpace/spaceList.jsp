...
<head>
	...
	<script type="text/javascript" src="${locResPath}/page/custom/creatorSpace/data.js"></script>
</head>
<body>
	<!-- 头部 -->
    ...
    <div class="main mat7" id="space_main" style="position:relative;z-index:40;">
    	...
    	<!-- 27：众创空间 -->
    	<input type="hidden" id="spaceType" name="spaceType" value="27"/>
