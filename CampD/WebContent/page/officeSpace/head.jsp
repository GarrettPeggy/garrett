...
<script type="text/javascript" src="${locResPath}/static/js/gift/gift.js?_v=${vs}"></script>
    ...
    <img class="searchPic" onclick="OfficeSpace.searchKey();"  src="${rmtResPath}/static/images/search.png" width="15" height="15"/>
    <img class="searchDel" onclick="OfficeSpace.delSearchKey();" src="${rmtResPath}/static/images/close.png" width="16" height="16"/>
