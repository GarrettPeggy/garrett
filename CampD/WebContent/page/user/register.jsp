    	...
    	<form id="registerForm">
	    	<div class="login-form form-box">
	        	<div class="line retina-1px-border-bottom">
	            	...
	            	<input type="text" class="text-input" name="userName" id="userName" maxlength="20" placeholder="请输入姓名"/>
	            </div>
	            <div class="line mab20">
	            	<div class="input-icon">
	                	<img src="${rmtResPath}/static/images/phone_icon.png" width="14" height="25">
	                </div>
	            	<input type="tel" class="text-input" name="mdn" id="mdn" maxlength="11" placeholder="请输入手机号码"/>
	            </div>
