					            ...
					            <div class="row">
					              <div class="col-xs-12">
					                <div class="form-horizontal">
					                  ...
					                  <div class="form-group ${systemConst.SPACE_TYPE_27 ne spaceMap.spaceInfo.space_type?'hide':''}" id="form-belongTo">
					                    <label class="col-sm-2 control-label no-padding-right">所属众创空间</label>
					                    <div class="col-sm-9">
					                      <div class="row">
					                        <div class="radio">
												<label style="padding-bottom: 10px;">
													<input name="belongTo" ${0 ne spaceMap.spaceInfo.belong_to?'':'checked="checked"'} class="ace ace-radio-0" value="0" type="radio">
													<span class="lbl">创斯卡</span>
												</label>
												<label style="padding-bottom: 10px;">
													<input name="belongTo" ${1 ne spaceMap.spaceInfo.belong_to?'':'checked="checked"'} class="ace ace-radio-1" value="1" type="radio">
